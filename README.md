...
用 MJGA 生成可直接运行的 Contract First 后端项目。选择 Kotlin 或 Java，再选择
jOOQ 或 Jimmer。

## 选择模板

每个分支都是一个完整、经过验证的项目。点击分支即可查看代码。
...
打开 [MJGA Configurator](https://www.mjga.cc/)，选择需要的组件并生成项目。
...
生成来源：`a84eb7cc741e3ea430b763be5fb968b6eaea943c`
